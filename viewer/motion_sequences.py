...
def wave_clip(t: float) -> PoseSample:
    ...
    local_rotations[Joint.LEFT_SHOULDER] = rotation_y(-1.02 + 0.28 * wave) @ rotation_z(0.10)
    local_rotations[Joint.LEFT_ELBOW] = rotation_y(-0.65)
    local_rotations[Joint.LEFT_WRIST] = rotation_z(0.08 * wave)
    local_rotations[Joint.RIGHT_SHOULDER] = rotation_z(0.16) @ rotation_y(0.14)
    local_rotations[Joint.RIGHT_ELBOW] = rotation_x(-0.10)
